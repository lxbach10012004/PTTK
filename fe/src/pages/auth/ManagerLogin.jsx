...
function ManagerLogin() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (success) {
        navigate('/manager'); // Chuyển hướng đến dashboard quản lý
      } else {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="bg-white p-8 rounded shadow-md w-full max-w-md">
        <h2 className="text-2xl font-bold mb-6 text-center">Đăng nhập Quản lý</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <button
              type="submit"
              className="w-full py-2 px-4 bg-purple-600 text-white font-semibold rounded-md shadow hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500"
            >
              Đăng nhập
            </button>
          </div>
