...
function SendNotification() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setMessage(
        `Gửi thông báo #${result.notification?.id_thong_bao || ""} thành công!`
      );
      setSuccess(true);
      ...
      setMessage(
        `Gửi thông báo thất bại: ${err.error || "Lỗi không xác định"}`
      );
      setSuccess(false);
    } finally {
    ...
    <div className="space-y-6">
      ...
      <div className="border-b border-gray-200 px-6 py-4">
        ...
        <p className="text-gray-600 mt-1">
          Tạo và gửi thông báo đến cư dân trong tòa nhà
        </p>
      </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <ul className="list-disc pl-5 text-sm text-gray-600 space-y-1">
                <li>
                  ...
                  : Các thông báo thông thường như thông báo họp, sự kiện...
                </li>
                <li>
                  <span className="px-2 py-0.5 text-xs font-semibold rounded-full bg-yellow-100 text-yellow-800">
                    Bảo trì
                  </span>
                  : Thông báo về việc bảo trì, sửa chữa cơ sở vật chất
                </li>
                <li>
                  <span className="px-2 py-0.5 text-xs font-semibold rounded-full bg-red-100 text-red-800">
                    Khẩn cấp
                  </span>
                  : Thông báo cần chú ý ngay như cháy, ngập lụt, mất an ninh
                </li>
                <li>
                  <span className="px-2 py-0.5 text-xs font-semibold rounded-full bg-green-100 text-green-800">
                    Thanh toán
                  </span>
                  : Nhắc nhở về các khoản phí cần thanh toán
                </li>
              </ul>
            </div>
            ...
            <div>
              <h3 className="font-medium text-gray-700 mb-1">
                Lưu ý khi gửi thông báo
              </h3>
              <ul className="list-disc pl-5 text-sm text-gray-600">
                <li>
                  Nội dung thông báo nên rõ ràng, đủ thông tin thời gian, địa
                  điểm (nếu có)
                </li>
                <li>
                  Với thông báo khẩn cấp, cần cung cấp hành động cụ thể người
                  dân cần làm
                </li>
