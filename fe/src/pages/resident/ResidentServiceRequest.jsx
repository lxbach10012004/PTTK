  ...
  return (
    <div className="space-y-6">
      ...
      <div className="border-b border-gray-200 pb-4">
        ...
        <p className="text-gray-600 mt-1">Đặt lịch sử dụng các dịch vụ tiện ích trong chung cư</p>
      </div>
      
      {/* Form yêu cầu dịch vụ */}
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold text-gray-800">Tạo yêu cầu dịch vụ mới</h2>
        </div>
              ...
              {selectedServiceInfo && (
                <div className="mt-2 p-3 bg-blue-50 rounded-md">
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-medium text-gray-700">Thông tin dịch vụ</span>
                    <span className="px-2 py-1 text-xs font-semibold rounded-full bg-blue-100 text-blue-800">
                      {selectedServiceInfo.trang_thai || 'Hoạt động'}
                    </span>
                  </div>
                  <p className="text-sm text-gray-600 mt-1">
                    <span className="font-medium">Mô tả:</span> {selectedServiceInfo.mo_ta || 'Không có mô tả'}
                  </p>
                  <p className="text-sm text-gray-600 mt-1">
                    <span className="font-medium">Đơn giá:</span> {selectedServiceInfo.don_gia?.toLocaleString('vi-VN')} VNĐ / {selectedServiceInfo.don_vi_tinh}
                  </p>
                </div>
              )}
            </div>
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold text-gray-800">Lưu ý khi sử dụng dịch vụ</h2>
        </div>
        
        <div className="p-6">
          <ul className="space-y-2 text-gray-600 list-disc pl-5">
            <li>Vui lòng đặt lịch trước ít nhất 24 giờ để đảm bảo dịch vụ được chuẩn bị tốt nhất</li>
            <li>Phí dịch vụ sẽ được tính vào hóa đơn tháng hoặc thanh toán trực tiếp tùy loại dịch vụ</li>
            <li>Nếu cần hủy hoặc thay đổi lịch, vui lòng thông báo trước ít nhất 4 giờ</li>
            <li>Mọi thắc mắc xin liên hệ ban quản lý qua số điện thoại: <span className="font-medium">0123 456 789</span></li>
          </ul>
        </div>
      </div>
    </div>
